/**
 * Video Integration Module Exports
 * 
 * Central export file for the video integration feature.
 * Exports main components for use in other parts of the application.
 */
