...
const DefinitionSlidesEp4PickUpCommunication = ({ onComplete }) => {
  ...
  const definitions = [
    {
      term: 'Pick Up Communication from ISS',
      definition:
        'For students arriving within the approved window, International Student Services will contact you with specific instructions regarding your pick up location and timing.'
    },
    {
      term: 'Required Student Action',
      definition: 'Please monitor your email closely and follow the instructions provided by the ISS office.'
    }
  ];
...
export default DefinitionSlidesEp4PickUpCommunication;
