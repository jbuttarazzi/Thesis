...
const DefinitionSlidesEp6Scene8 = ({ onComplete }) => {
  ...
  const definitions = [
    {
      term: 'ISS Message',
      definition: 'Read through the campus safety policies. Serious conduct violations can impact both your academic standing and your immigration status.'
    }
  ];
...
export default DefinitionSlidesEp6Scene8;
