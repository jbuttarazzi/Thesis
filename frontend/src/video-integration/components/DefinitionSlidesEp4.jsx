...
const DefinitionSlidesEp4 = ({ onComplete }) => {
  ...
  const definitions = [
    {
      term: 'The 30-Day Entry Rule',
      definition:
        'As an F-1 student, you may not enter the United States more than 30 days before the program start date listed on your I-20.'
    },
    {
      term: 'ISS Tip',
      definition: 'Early entry can result in denied entry or status issues.'
    }
  ];
...
export default DefinitionSlidesEp4;
