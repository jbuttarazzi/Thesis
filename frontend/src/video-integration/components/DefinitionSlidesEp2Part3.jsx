...
/**
 * filename: DefinitionSlidesEp2Part3.jsx
 * 
 * description: Flashcards for Episode 2 visa and travel records information.
 * 
 */
const DefinitionSlidesEp2Part3 = ({ onComplete }) => {
  ...
  const definitions = [
    {
      term: 'Visa',
      definition: 'This is the sticker placed in your passport that allows you to request entry to the U.S. It does not determine how long you can stay.'
    },
    {
      term: 'Travel Records',
      definition: 'These include entry stamps, I-94 records, and travel signatures used when entering or reentering the U.S.'
    },
    {
      term: '',
      definition: 'Keep digital and physical copies whenever possible.'
    }
  ];
...
export default DefinitionSlidesEp2Part3;
