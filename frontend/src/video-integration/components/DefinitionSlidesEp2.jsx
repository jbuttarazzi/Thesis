...
const DefinitionSlidesEp2 = ({ onComplete }) => {
  ...
  const definitions = [
    {
      term: 'Passport',
      definition: 'This confirms your identity and citizenship. It must be valid for at least six months into the future when entering the U.S.'
    },
    {
      term: 'Financial Documentation',
      definition: 'This shows that you have sufficient funding to cover tuition and living expenses. This is required by U.S. immigration regulations.'
    },
    {
      term: 'Address Information',
      definition: 'This is the address the school will use for official records and SEVIS reporting. It should be accurate and up to date.'
    },
    {
      term: '',
      definition: 'These documents help us issue an accurate I-20. Accuracy matters.'
    }
  ];
...
export default DefinitionSlidesEp2;
