...
const DefinitionSlidesEp4TravelInformation = ({ onComplete }) => {
  ...
  const definitions = [
    {
      term: 'Sharing Travel Information with ISS',
      definition:
        'Once you receive your visa and book your travel, you must share your complete travel details with International Student Services.'
    },
    {
      term: 'Required Information',
      definition: '• Airline and flight number\n• Arrival date\n• Arrival airport or station\n• Estimated arrival time'
    }
  ];
...
export default DefinitionSlidesEp4TravelInformation;
