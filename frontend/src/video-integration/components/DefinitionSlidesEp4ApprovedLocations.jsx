...
const DefinitionSlidesEp4ApprovedLocations = ({ onComplete }) => {
  ...
  const definitions = [
    {
      term: 'Approved Arrival Locations',
      definition:
        'For arrival support, Hamilton College will only provide student pick up from the following locations:\n• Syracuse Hancock International Airport\n• Utica Amtrak Train Station, 321 Main Street, Utica, NY 13501'
    },
    {
      term: 'Other Arrival Locations',
      definition: 'Students arriving at other locations will be responsible for arranging their own transportation to campus.'
    }
  ];
...
export default DefinitionSlidesEp4ApprovedLocations;
