...
const DefinitionSlidesEp5Scene2 = ({ onComplete }) => {
  ...
  const definitions = [
    {
      term: 'What Is International Student Orientation',
      definition:
        'International Student Orientation is a required program for all international students. It is not the same as Hamilton College First Year Orientation.'
    },
    {
      term: 'ISS Guidance',
      definition: 'All international students must attend International Student Orientation, regardless of class year or participation in other orientation programs.'
    }
  ];
...
export default DefinitionSlidesEp5Scene2;
