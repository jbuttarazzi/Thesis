...
const DefinitionSlidesEp4ArrivalLodging = ({ onComplete }) => {
  ...
  const definitions = [
    {
      term: 'Arrival Time and Overnight Lodging',
      definition:
        'Students who arrive after 12:00 pm will be lodged in a local hotel and picked up the following day by Hamilton College transportation.'
    },
    {
      term: 'Guest Arrangement',
      definition: 'This arrangement is for students only.'
    }
  ];
...
export default DefinitionSlidesEp4ArrivalLodging;
