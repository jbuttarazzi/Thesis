...
const DefinitionSlidesEp4CampusArrival = ({ onComplete }) => {
  ...
  const definitions = [
    {
      term: 'Campus Arrival Timing',
      definition:
        'Students may not arrive on campus more than two days before the first day of International Student Orientation.'
    },
    {
      term: 'Orientation Dates',
      definition:
        'Orientation dates are published on the Hamilton College website and updated annually.'
    }
  ];
...
export default DefinitionSlidesEp4CampusArrival;
